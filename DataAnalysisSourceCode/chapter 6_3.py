...
for name, group in x1.groupby('key1'):
    print ("name = ", name)
    print ("group = ", group)
    print ("------------------------")

x10 = x1.groupby('key1')['data1']
x12 = x1['data1'].groupby(x1['key1'])

x11 = x1.groupby('key1')[['data2']]
x13 = x1[['data2']].groupby(x1['key1'])

x14 = x1.groupby(['key1','key2'])[['data2']].mean()
print ("x14 = \n", x14)
